...
import {Chooseservice} from "./pages_after_seeprices/chooseservice";
  ...
  return <>
    ...
    <Navbar />
      <Routes>
        ...
        <Route path="/home/seeprices" element={<Seeprices />}/>
        <Route path="/seeprices/chooseservice" element={<Chooseservice />}/>
